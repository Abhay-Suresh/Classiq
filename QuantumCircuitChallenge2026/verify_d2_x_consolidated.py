#!/usr/bin/env python3
"""
Full statevector verification for the D2 X-Consolidated + D2 Core First circuit (Depth 3,820 / CX 2,518).
"""
import re
import warnings
...
def main(x: Output[QNum[COORD_BITS]], y: Output[QNum[COORD_BITS]]) -> None:
    ...
    oracle_d2_x_consolidated_d2_first(x, y)

print("Synthesizing D2 X-Consolidated + D2 Core First model...")
