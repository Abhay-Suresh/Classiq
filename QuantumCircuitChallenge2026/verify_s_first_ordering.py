#!/usr/bin/env python3
"""
Full statevector verification for the S-First Control Ordering circuit (Depth 3,960).
"""
import re
import warnings
...
def main(x: Output[QNum[COORD_BITS]], y: Output[QNum[COORD_BITS]]) -> None:
    ...
    oracle_order_s_first(x, y)

print("Synthesizing S-First Ordering model...")
