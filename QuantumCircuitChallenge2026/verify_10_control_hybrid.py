#!/usr/bin/env python3
"""
Full statevector verification for the 10-Control Hybrid circuit (Depth 3,992).
"""
import re
import warnings
...
print("Synthesizing 10-Control Hybrid model...")
...
if max_error < STATE_ERROR_THRESHOLD and ancilla_error < STATE_ERROR_THRESHOLD:
    ...
    print("Updated submission.qasm and final_best.qasm with Depth 3,992!")
else:
    print("\n>>> VERIFICATION FAILED! <<<")
